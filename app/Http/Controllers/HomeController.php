...
class HomeController extends Controller
{
    ...
    //Funkcija za posodabljanje last_online pri userju v bazi 
    public function update(){
        $result=User::updateUserTimestamp();
        return $result;
    }
    //Funkcija za pridobivanje uporabnikov, ki so pijavljeni
