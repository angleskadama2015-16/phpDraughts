...
<div class="container-fluid text-center">
    <div class="row content">
        ...
        <div class="col-sm-8 text-left">
            <?php echo $__env->yieldContent('firstview'); ?><!--Dobimo vsebino, ki se nahaja v welcome.blade.php pod sekcijo 'firstview'-->
            <?php echo $__env->yieldContent('about'); ?> <!--Dobimo vsebino, ki se nahaja v about.blade.php pod sekcijo 'about'-->
            <?php echo $__env->yieldContent('rules'); ?> <!--Dobimo vsebino, ki se nahaja v rules.blade.php pod sekcijo 'rules'-->
        </div>
        <div class="col-sm-2 sidenav">
            <div class="well">
                <p>ADS</p>
